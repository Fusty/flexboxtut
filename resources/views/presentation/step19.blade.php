...
@section("content")
    ...
    <div style="display:flex;flex-direction:column;justify-content:center;align-items:stretch;">
        <div style="display:flex;flex-direction:row;justify-content:space-around;">
            <div>
                Slamming things to the bottom of the div<br/>
                <code>
                    display:flex;<br/>
            ...
            <div class="parent" style="display:flex;flex-direction:row;flex-wrap:wrap;justify-content:space-around;align-items:flex-end;min-width:600px">
                <div class="child">
                    Item 1
                </div>
                <div class="child">
