...
@section("content")
    <div style="display:flex;flex-direction:column;justify-content:center;align-items:stretch;">
        <div class="row">
            ...
            <div class="parent col-xs-6" style="display:flex;flex-direction:row;flex-wrap:wrap;justify-content:flex-start;align-items:flex-start;align-content:space-around;min-height:400px;padding:0px;">
                <div class="child">
                    Item 1
                </div>
                <div class="child">
