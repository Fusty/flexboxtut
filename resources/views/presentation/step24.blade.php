...
@section("content")
    ...
    <div style="display:flex;flex-direction:column;justify-content:center;align-items:stretch;">
        <div class="row">
            <div class="col-xs-6">
                Keep them slammed together but at the bottom<br/>
                <code>
                    display:flex;<br/>
            ...
            <div class="parent col-xs-6" style="display:flex;flex-direction:row;flex-wrap:wrap;justify-content:flex-start;align-items:flex-start;align-content:flex-end;min-height:400px;padding:0px;">
                <div class="child">
                    Item 1
                </div>
                <div class="child">
